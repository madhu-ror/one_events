...
Devise.setup do |config|
  ...
  # config.secret_key = 'aa0ba4d40a1e4d7d040109846396e0f981b93993b39f16ae81e571aa75596d25c4bf7e0f4380ff6690e6c7cd027bc6043f8c5fddadfcfff82a18b801ac4ed14d'
  ...
  config.omniauth :facebook, Rails.application.credentials.facebook[:APP_ID], Rails.application.credentials.facebook[:APP_SECRET], scope: 'email', info_fields: 'email, first_name,middle_name,last_name,name', display: 'popup', token_params: { parse: :json }
  ...
  # config.pepper = '9acd023c056bf6933b5ca05e3d5394f3c143e2aa6b5f465aebbd35f405b4704974baf791d44bf88b2eeef88aa9d93a3270f1e5298c52929e31cbfd5b5b0d5061'
